...
import { obtenerBarrios } from '../../api/neighborhoodsApi.js'
import  {registerCustomerApi} from '../../api/customerApi.js'
...
export default function RegisterCustomerMq({setChange, datosUsuario}) {
    ...
    //conversion de datos a JSON de CustomerData
        ...
        try{
            ...
            console.error("Fallo en el registro del cliente:", error.message);
            setMensaje(`Fallo en el registro del cliente: ${error.message}`);            
        }finally{

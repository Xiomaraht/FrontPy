...
import InputMq from '@/components/common/InputMq';
import "@/components/styles/ModalMq.css";
import SelectorMq from '@/components/common/SelectorMq';
import UploadImagenMq from '@/components/common/UploadImageMq';

...
import SidebarLg from '../components/Laura/SidebarLg';
import HeaderAdmiGeneralLg from '../components/Laura/HeaderAdmiGeneralLg';
import TableVetsLg from '../components/Laura/TableVetsLg'; // Ahora una tabla genérica
import PaginacionLg from '../components/Laura/PaginacionLg';
import DetailCardLg from '../components/Laura/DetailCardLg';
import ButtonLg from '../components/Laura/ButtonLg';

// Componentes específicos de Veterinarias
import AddVetLg from '../components/Laura/AddVetLg';
import ProfileCreatedLg from '../components/Laura/ProfileCreatedLg';
import InitialVetsData from '../components/Data/VetsDataLg.json';
import ContenidoAdminGeneralMq from '../components/Manuel/ContenidoAdminGeneralMq';
import VetsAddTl from '../components/Tomas/VetsAddTl'; //Esto se esta usando? @Manuel

// Componentes específicos de Administradores (antes Usuarios)
import UsersRegisterTL from '../components/Tomas/UsersRegisterTL'; // Formulario de registro de administradores
...
// import VetRegisterTL from './components/Tomas/VetRegisterTL'; // Parece no usarse, lo dejo comentado si no lo necesitas

...
import { obtenerServicios } from '../api/servicesApi.js'; 
...
import FilterLw from '../components/Lina/FilterLw';
import CardLw from '../components/Lina/CardLw';
import PaginationLw from '../components/Lina/PaginationLw.jsx';
                    ...
                    <div className="product-grid">
                        {paginatedServices.map(service => (
                            <Link key={service.id} to={`/servicios/${service.id}`}>
                                <CardLw
                                    // 🛑 AJUSTE AQUÍ: Cambia 'service.nombre' a 'service.name' si tu API lo envía así
                                    productName={service.name || service.nombre || 'Servicio sin nombre'} 
                                    
                                    // Si CardLw también tiene un prop para la imagen (ej: imageUrl)
                                    imageUrl={service.imagenUrl || service.image || null} 

...
import { obtenerProductos } from '../api/productsApi.js' 
import { obtenerCategorias } from '../api/categoriesApi.js';
...
                                    imageUrl={producto.imagenPrincipal || producto.imageUrl ||  producto.picture || null}
                                />
                            </Link>
                        ))
                        ) : (
